...
export function ArduinoLab() {
  ...
  return (
    <>
      <DesktopOnlyNotice labName="Arduino Lab" />
      <div className="hidden h-full flex-col lg:flex">
        <div className="flex items-center justify-between border-b border-hairline bg-ivory px-4 py-3">
          <div>
            <h1 className="font-serif text-[16px] text-charcoal">Arduino Lab</h1>
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <div className="flex w-[420px] shrink-0 flex-col">
            ...
            <pre
              tabIndex={0}
              aria-label="AVR assembly source, read-only"
              className="flex-1 overflow-auto bg-[#1C1B18] p-4 font-mono text-[12px] leading-relaxed text-ivory/80"
            >
              {BLINK_SOURCE}
            </pre>
            <div className="border-t border-hairline bg-white px-4 py-3 text-[12px] leading-relaxed text-charcoal-muted">
              No live code editing yet — this demo runs fixed, precompiled AVR machine
              code, not sketch text you type. See docs/architecture/0007-*.md for why.
            </div>
          </div>
        </div>
        ...
        <div className="h-[92px] shrink-0 border-t border-hairline bg-white px-4 py-2">
          ...
          <p className="mt-1 text-[12px] leading-relaxed text-charcoal-muted">
