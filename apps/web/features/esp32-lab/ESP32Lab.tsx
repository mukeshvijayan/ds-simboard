  ...
  return (
    <div className="flex h-screen flex-col">
      <div className="flex items-center justify-between border-b border-hairline bg-ivory px-4 py-3">
        <div>
          <p className="font-serif text-[16px] text-charcoal">ESP32 Lab</p>
          ...
          <div
            className={`flex items-center gap-2 rounded-sm border px-3 py-1.5 text-[12px] ${
              wifiStatus === "connected"
                ...
                : "border-hairline bg-white text-charcoal-faint"
            }`}
          >
            <span
            ...
            <span className="text-charcoal-faint">(stub — no real network stack)</span>
          </div>
        </div>
