export function Servo({ angle = 90 }: { angle?: number }) {
  return (
    <svg viewBox="0 0 60 50" width={60} height={50} role="img" aria-label={`Servo, ${angle} degrees`}>
      <rect x="8" y="14" width="44" height="30" rx="2" fill="#EDEBE3" stroke="#22314F" strokeWidth="1.2" />
