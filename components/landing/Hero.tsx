        ...
        <div className="grid items-center gap-14 md:grid-cols-[1.05fr_1fr]">
          <div>
            ...
            <p className="mt-6 max-w-[46ch] text-[17px] leading-relaxed text-charcoal-muted">
              Wire an Arduino Uno or ESP32 on screen, write the sketch that
              drives it, and watch the circuit respond in real time — then
              flash the exact same code to the board sitting on your desk.
            </p>
